...
class_dir = os.path.join(home, "class_first_order_1")
...
plt.title(u"Matter Power Spectrum - quasi-free streaming")
...
# === Lensing φφ Spectrum ===
plt.figure(figsize=(9, 6))
plt.title(u"Lensing $\phi\phi$ Spectrum - quasi-free streaming")
